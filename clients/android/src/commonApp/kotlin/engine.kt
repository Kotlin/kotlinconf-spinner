...
internal expect class SoundWrapper() {
    val soundPlayer: SoundPlayer

    fun playSoundIfAvailable()
    fun deinitSoundIfAvailable()
}
...
class Engine(val arena: NativePlacement, val state: NativeActivityState) {
    ...
    private val soundWrapper = SoundWrapper()

    private val gameState: GameState = GameState(SceneState(), statsFetcher, soundWrapper.soundPlayer)
